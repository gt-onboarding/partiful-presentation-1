        ...
        <div className="flex justify-between items-center">
          <button 
            ...
            onClick={() => {
              ...
              const prefix = pageType === "demo" ? "" : `/${pageType}`;
              window.location.href = `${prefix}${prevPath}`;
            }} 
          ...
          <div className="flex gap-2">
            <button 
              ...
              onClick={() => window.location.href = `/base${currentTutorialPath}`}
            ...
            <button 
              className="px-4 py-1 rounded text-sm font-medium transition-colors disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed bg-green-500 hover:bg-green-600 text-white" 
              onClick={() => window.location.href = currentTutorialPath}
            ...
            <button 
              className="px-4 py-1 rounded text-sm font-medium transition-colors disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed bg-green-500 hover:bg-green-600 text-white" 
              onClick={() => window.location.href = `/example${currentTutorialPath}`}
          ...
          <button 
            ...
            onClick={() => {
              ...
              const prefix = pageType === "demo" ? "" : `/${pageType}`;
              window.location.href = `${prefix}${nextPath}`;
            }} 
